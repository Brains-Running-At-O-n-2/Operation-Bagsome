...
public class ResizableArrayBagTest {
    ...
    public void bagSizeShouldBe5AfterAdding5Items() {
        BagInterface<Double> bag = new ResizableArrayBag<>();
        // add the two items to the bag
        bag.add(1.5);
        bag.add(2.2);
        bag.add(3.9);
    ...
    @Test
    public void shouldBeFullSinceAtMaxCapactiy() {
        BagInterface<Integer> bag = new ResizableArrayBag<>();
        // add 25 items to the bag since default bag size is 25 items
        for (int i = 0; i < 25; i++) {
            bag.add(i);
        }
        Assert.assertTrue(bag.isFull());
    }
    ...
    public void doubleArraysShouldBeEqual() {
        ...
        // initialize bag with 2.0, 2.0, 3.5, 4.7
        bag.add(2.0);
        bag.add(2.0);
        bag.add(3.5);
        bag.add(4.7);
    ...
    public void shouldBeBagWithAllItemsFromBag1AndBag2Combined() {
        ...
        BagInterface<String> bagExpected = new ResizableArrayBag<>();
        // initialize bags
        bag1.add("a");
        bag1.add("b");
        bag1.add("c");
